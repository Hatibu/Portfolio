...
const Projects = () => {
  ...
  return (
    <>
      <div className='project lg:py-20 lg:px-0 px-4 max-w-full'>
        <div className='lg:px-6 lg:py-0 py-4'>
          <Link to='/'>
            <BsBoxArrowLeft className='text-3xl text-white font-bold' />
          </Link>
        </div>
        <div className='grid lg:flex gap-6 lg:px-32 py-6 lg:py-0 '>
          {/*section 1 */}
          <div className='lg:w-2/5 px-4 py-8 bg-white  rounded-md shadow-2xl'>
            <img
              className='rounded-full shadow h-28 w-28 mb-4 border-2 border-gray-200 ml-28 lg:ml-36'
              src={profileUrl}
              alt='hello'
            />
            ...
            <p className='text-center px-2 py-2 my-3 bg-gray-300 rounded-full dark:text-white dark:bg-gray-800'>
              Software Engineer
            </p>
            <a
              href={resumeUrl}
              download='name'
              className='flex items-center justify-center px-2 py-2 my-3 bg-gray-300 rounded-full dark:text-white dark:bg-gray-800'
            >
              Download resume
            </a>
          ...
          {/*section 2 */}
          <div className='lg:w-3/5  px-4 py-6 bg-white rounded-md shadow-md '>
            ...
            {/* projects tab */}
            <div className='grid lg:flex gap-4 py-4'>
              {MyProjects.map((value) => (
                <div
                  key={value.id}
                  className='bg-gray-300 h-84 rounded p-4 grid gap-3'
                >
                  <div className='h-36'>
