        ...
        <div className="section">
                ...
                <div className="max-w-sm w-full rounded-xl lg:p-10 overflow-hidden shadow-lg bg-white m-1.5 ">
                    ...
                    <span className="icons inline-block w-28 h-28 px-3 py-1 text-sm hover:bg-blue-400 border-8 border-blue-400 hover:border-blue-200 hover:text-white font-semibold text-gray-700 text-center">
                        ...
                        <p className="text-gray-700 text-base">
                        I can build responsive and optmized SPA user interface's by using HTML5,
                         CSS3, React.js and Firebase. 
                        </p>
                    </div>
                    <div className="px-6 pt-4 pb-2">
                    ...
                    <span className="icons inline-block w-28 h-28 px-3 py-1 text-sm hover:bg-blue-400 border-8 border-blue-400 hover:border-blue-200 hover:text-white font-semibold text-gray-700 text-center">
                        ...
                        <p className="text-gray-700 text-base">
                        I can build scalable and optimized backend services by using Laravel(PHP), 
                        Nodejs(Javascript), firebase, and handling databases.
                        </p>
                    </div>
                    <div className="px-6 pt-4 pb-2">
             ...
             <div className="w-full px-6 -ml-2">
                ...
                <div className="max-w-sm  lg:p-10 w-full overflow-hidden rounded-xl shadow-lg bg-white m-1.5">
                    <div className="px-6 py-4">
                        ...
                        <p className="text-gray-700 text-base">
                        I can build scalable and optimized REST API by using Laravel, Flask, and NodeJS.
                        </p>
                    </div>
                    <div className="px-6 pt-4 pb-2">
                    ...
                    <div className="px-6 py-4">
                        ...
                        <h1 className="font-bold uppercase text-xl mb-2">DATABASE DESIGN</h1>
                        <p className="text-gray-700 text-base">
                        I can build scalable and optimized database 
                        services from requirement analysis, database
                         design, and implementation by using MongoDB, 
                         firebase, Mysql, PostgreSQL, and SQL server.
                        </p>
                    </div>
