             ...
             <div className=" w-full h-screen bg-indigo-100 lg:flex gap-4 lg:px-20  md:flex  md:p-10 p-4 ">
               <div class="bg-white  shadow mb-4 rounded-lg p-6 px-10 lg:w-5/6  w-full lg:mt-10 md:mt-10">
                ...
                Dedicated and efficient Full Stack Developer with 2+ years
                 of hands-on experience in designing, developing, and 
                 implementing applications and solutions using a range 
                 of technologies and programming languages. Seeking to 
                 leverage broad development experience and hands-on technical
                  expertise in a challenging role as a Full-stack Developer.
                   I am a highly competent web application software developer
                    with professional experience developing a wide range of tools
                     for both frontend and backend for a range of clients. 
                     I have proven expertise in building API.                                                    
                    </p>
